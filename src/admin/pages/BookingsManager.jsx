...
const L = {
  ar: {
    ...
    subtitle: "تابع المواعيد القادمة وحدّث حالة كل حجز بوضوح",
    name: "الاسم",
    email: "البريد",
    company: "الشركة",
    date: "التاريخ",
    ...
    noResults: "لا توجد حجوزات مطابقة. جرّب تغيير فلتر الحالة.",
    join: "انضمام",
    noLink: "\u2014",
    statusHint: "اختر الحالة الحالية للحجز.",
    joinHint: "فتح رابط الاجتماع لهذا الحجز في نافذة جديدة.",
    deleteHint: "حذف هذا الحجز من لوحة الإدارة.",
  },
  en: {
    title: "Bookings Manager",
    subtitle: "Track upcoming meetings and update each booking clearly",
    name: "Name",
    email: "Email",
    company: "Company",
    date: "Date",
    ...
    noResults: "No matching bookings. Try a different status filter.",
    join: "Join",
    noLink: "\u2014",
    statusHint: "Select the current booking status.",
    joinHint: "Open this booking's meeting link in a new tab.",
    deleteHint: "Delete this booking from the admin list.",
  },
};
