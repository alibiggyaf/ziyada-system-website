...
const L = {
  ar: {
    ...
    subtitle: "نظّم الأسئلة الأكثر تكرارًا لتسهيل فهم العملاء قبل التواصل",
    newFaq: "سؤال جديد",
    ...
    noResults: "لا توجد أسئلة شائعة بعد. أضف أول سؤال من زر \"سؤال جديد\".",
    ...
    collapseAll: "طي الكل",
    answer: "الإجابة",
    newFaqHint: "إضافة سؤال جديد مع إجابة واضحة للعميل.",
    publishHint: "تغيير حالة السؤال بين منشور وغير منشور.",
    editHint: "تعديل السؤال أو الإجابة.",
    deleteHint: "حذف هذا السؤال من لوحة الإدارة.",
    expandHint: "عرض أو إخفاء الإجابة الكاملة.",
  },
  en: {
    title: "FAQ Manager",
    subtitle: "Organize common questions so clients understand faster",
    newFaq: "New FAQ",
    editFaq: "Edit FAQ",
    ...
    noResults: "No FAQs yet. Add your first FAQ from the New FAQ button.",
    ...
    answer: "Answer",
    newFaqHint: "Add a new question with a clear customer-facing answer.",
    publishHint: "Switch this FAQ between published and unpublished.",
    editHint: "Edit this FAQ question or answer.",
    deleteHint: "Delete this FAQ from admin.",
    expandHint: "Show or hide the full answer.",
  },
};
                            ...
                            <div className="flex items-center gap-3 p-4">
                              ...
                              <div className="flex items-center gap-1 flex-shrink-0">
                                <button
                                  ...
                                  title={`${faq.published !== false ? t.unpublish : t.publish} - ${t.publishHint}`}
                                  className={cn(
