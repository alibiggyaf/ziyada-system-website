...
const L = {
  ar: {
    title: "إدارة الخدمات",
    subtitle: "حدّث بطاقات الخدمات لتبقى واضحة ومقنعة للعميل",
    ...
    noResults: "لا توجد خدمات بعد. ابدأ بإضافة أول خدمة من زر \"خدمة جديدة\".",
    publish: "نشر",
    unpublish: "إلغاء النشر",
    totalServices: "إجمالي الخدمات",
    publishedCount: "منشور",
    description: "الوصف",
    newServiceHint: "إضافة بطاقة خدمة جديدة للعرض في الموقع.",
    editHint: "تعديل تفاصيل الخدمة الحالية.",
    deleteHint: "حذف هذه الخدمة من لوحة الإدارة.",
    publishHint: "تغيير حالة الخدمة بين منشور وغير منشور.",
  },
  en: {
    title: "Services Manager",
    subtitle: "Keep service cards clear, updated, and client-ready",
    ...
    noResults: "No services yet. Start by adding your first service card.",
    publish: "Publish",
    unpublish: "Unpublish",
    totalServices: "Total Services",
    publishedCount: "Published",
    description: "Description",
    newServiceHint: "Add a new service card to display on the website.",
    editHint: "Edit this service details.",
    deleteHint: "Delete this service from the admin panel.",
    publishHint: "Switch this service between published and unpublished.",
  },
};
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex items-center gap-1.5 flex-shrink-0">
                    <button
                      ...
                      title={`${svc.published !== false ? t.unpublish : t.publish} - ${t.publishHint}`}
                      className={cn(
                        "rounded-lg p-2 transition-colors",
                        svc.published !== false
