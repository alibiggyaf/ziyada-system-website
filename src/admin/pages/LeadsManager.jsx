...
const L = {
  ar: {
    ...
    subtitle: "راجع العملاء القادمين من النماذج وحدد الخطوة التالية لكل عميل",
    name: "الاسم",
    email: "البريد",
    phone: "الهاتف",
    company: "الشركة",
    ...
    to: "إلى",
    entries: "سجل",
    exportHint: "تنزيل العملاء الظاهرين حاليًا كملف CSV للتحليل أو المتابعة.",
    deleteHint: "حذف هذا العميل من قائمة الإدارة.",
    statusHint: "تحديث حالة هذا العميل المحتمل حسب آخر تواصل.",
  },
  en: {
    title: "Leads Manager",
    subtitle: "Review incoming leads and assign the next follow-up step",
    name: "Name",
    email: "Email",
    phone: "Phone",
    company: "Company",
    ...
    noResults: "No matching results. Adjust filters or broaden your search.",
    ...
    to: "to",
    entries: "entries",
    exportHint: "Download currently visible leads as a CSV file.",
    deleteHint: "Delete this lead from the admin list.",
    statusHint: "Update this lead's current pipeline status.",
  },
};
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  disabled={safePage <= 1}
                  title={`${t.page} ${Math.max(1, safePage - 1)}`}
                  className={cn(
                ...
                <button
                  ...
                  title={`${t.page} ${Math.min(totalPages, safePage + 1)}`}
                  className={cn(
                    "p-1.5 rounded-lg transition-colors disabled:opacity-30",
                    isDark
                      ? "hover:bg-white/10 text-gray-300"
